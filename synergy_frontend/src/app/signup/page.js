      ...
      <div className="w-1/2 flex flex-col justify-center p-8 bg-white">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input type="text" name="name" className="w-full p-3 border rounded bg-green-50" onChange={handleChange} required />
          </div>
          ...
          <div>
            ...
            <input type="text" name="phone" className="w-full p-3 border rounded bg-green-50" onChange={handleChange} required />
          </div>

          <div>
            <label className="block text-gray-700">Create a Strong Password:</label>
          ...
          <div>
            ...
            <input type="password" name="confirmPassword" className="w-full p-3 border rounded bg-green-50" required />
          </div>
